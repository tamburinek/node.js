...
import { createWebSocketServer, sendTodoListToAllConnections, 
  sendTodoDetailToAllConnections, sendTodoDetaiRemovelToAllConnections } from './src/websockets.js'
...
app.get('/remove-todo/:id', async (req, res) => {
  ...
  sendTodoListToAllConnections()
  sendTodoDetaiRemovelToAllConnections(todo.id)
